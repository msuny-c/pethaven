      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="p-4 bg-amber-50 border border-amber-100 rounded-xl">
          ...
          <div className="text-xs text-amber-700 mt-1">
            На смене: {stats.attended} • Сдали: {stats.submitted} • Принято: {stats.approved}
          </div>
        </div>
        <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl">
          ...
          <div className="text-xs text-blue-700 mt-1">
            В работе: {stats.tasksInProgress} • Открыто: {Math.max(stats.tasksTotal - stats.tasksDone - stats.tasksInProgress, 0)}
          </div>
        </div>
        <div className="p-4 bg-green-50 border border-green-100 rounded-xl">
          ...
          <div className="text-xs text-green-700 mt-1">Принято смен: {stats.approved}</div>
        </div>
      </div>
